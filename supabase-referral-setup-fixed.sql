...
-- 4. Create indexes (use SQL Editor for these)
CREATE INDEX IF NOT EXISTS public.idx_referrals_referrer_id ON public.referrals(referrer_id);
CREATE INDEX IF NOT EXISTS public.idx_referrals_referred_user_id ON public.referrals(referred_user_id);
CREATE INDEX IF NOT EXISTS public.idx_referrals_code ON public.referrals(referral_code);
CREATE INDEX IF NOT EXISTS public.idx_referral_earnings_referrer_id ON public.referral_earnings(referrer_id);
CREATE INDEX IF NOT EXISTS public.idx_referral_earnings_referred_user_id ON public.referral_earnings(referred_user_id);

-- 5. Create stats function (use SQL Editor for this)
